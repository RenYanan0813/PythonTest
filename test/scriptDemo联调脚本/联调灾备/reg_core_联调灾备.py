        ...
        with open('%s'%cfg,'r+') as f:
            ...
            for line in data:
                ...
                if '"grp_cfg"' in line and mark2 == False:
                    line_rownum = data.index(line)
                    new_line = '    "grp_cfg" : "/nfs/conf/group_reg.cfg",\n'
                    data[line_rownum] = new_line
...
print('************ log and grp have been modified sucessfully ! ***************')
            ...
            with open('acsvr_wh.cfg','r+') as fw:
                ...
                for line in data:
                    if '"server_ip"' in line:
                        nu = data.index(line)
                        data[nu] = '        "server_ip" : "180.2.34.199",\n'
    ...
    if 'rescsvr' in ser_list:
        with open('rescsvr.cfg','r+') as fr:
            ...
            for line in data:
                if '"grp_cfg"' in line :
                    num = data.index(line)
                    data[num] = '"grp_cfg" : "/nfs/conf/group_reg.cfg",\n'
                if '"name"' in line:
                    num = data.index(line)
                    data[num] = '"name" : "./log/rescsvr",\n'
...
if __name__ == '__main__':
    ...
    #     reload(sys)
    #     sys.setdefaultencoding('utf-8')
    big_list = read_excel('reg_conf199-202real.xls')
    main(big_list)
